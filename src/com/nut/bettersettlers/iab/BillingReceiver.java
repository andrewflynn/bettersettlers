...
public class BillingReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (IabConsts.ACTION_PURCHASE_STATE_CHANGED.equals(action)) {
    ...
    private void purchaseStateChanged(Context context, String signedData, String signature) {
        Intent intent = new Intent(IabConsts.ACTION_PURCHASE_STATE_CHANGED);
        intent.setClass(context, BillingService.class);
        intent.putExtra(IabConsts.INAPP_SIGNED_DATA, signedData);
        intent.putExtra(IabConsts.INAPP_SIGNATURE, signature);
    ...
    private void notify(Context context, String notifyId) {
        Intent intent = new Intent(IabConsts.ACTION_GET_PURCHASE_INFORMATION);
        intent.setClass(context, BillingService.class);
        intent.putExtra(IabConsts.NOTIFICATION_ID, notifyId);
        context.startService(intent);
    }
    ...
    private void checkResponseCode(Context context, long requestId, int responseCodeIndex) {
        Intent intent = new Intent(IabConsts.ACTION_RESPONSE_CODE);
        intent.setClass(context, BillingService.class);
        intent.putExtra(IabConsts.INAPP_REQUEST_ID, requestId);
        intent.putExtra(IabConsts.INAPP_RESPONSE_CODE, responseCodeIndex);
        context.startService(intent);
    }
}
